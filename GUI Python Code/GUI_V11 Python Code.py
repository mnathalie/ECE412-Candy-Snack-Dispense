...
class PageOne(ttk.Frame):
    ...
    def make_widget(self, controller):
        ...
        button1 = ttk.Button(self, text="Dispensing" , command=self.validate_disp)                           #Button for Dispensing
        ...
        button3 = ttk.Button(self, text='Testings',command=self.pagethree)   #Button for Testings
        button3.grid(pady=10)

    def validate_disp(self):                                                                 #This will execute when Dispense Button is clicked
       ...
       # while GPIO.input(21) == 0:                                                      #Wait until a handshake signal received from the FPGA development board
        time.sleep(2)           #let dispense for 1 second, duration subject to change
...
class PageThree(ttk.Frame):                             #PageThree = Testings Page
    def __init__(self, parent, controller):
        ...
        button5 = ttk.Button(self, text='Return to HomePage',command=self.returnHomepage)        #A button to return to Homepage                       
